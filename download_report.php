...
$query = "
    ...
    JOIN
        users u ON ca.instructor_id = u.id
    JOIN
...
fputcsv($output, ['Batch', 'Class', 'Start Date', 'Start Time', 'End Date', 'End Time', 'Instructor', 'Student', 'Attendance Status', 'Attendance Date']);
