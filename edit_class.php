...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE classes SET batch_id = '$batch_id', class_name = '$class_name' WHERE id = $class_id";
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="batch_id" name="batch_id" required>
                                    ...
                                    <option value="<?php echo $batch['id']; ?>"
                                        <?php if ($batch['id'] == $class['batch_id']) echo 'selected'; ?>>
                                        <?php echo $batch['course_name']; ?> (Batch ID: <?php echo $batch['id']; ?>)
                                    </option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
